  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ backgroundImage: `url('${process.env.REACT_APP_BASEIMGURL}/${detail.backdrop_path}` }}
      >
        ...
        <div className="absolute top-[47%] left-[7%] w-[500px]">
          ...
          <div className="flex items-center gap-8">
            <a href="#" className="flex items-center gap-2 bg-cyan-500 w-fit lg:mt-2 rounded-sm text-[8px] md:text-[12px] lg:text-[1vw] px-3 py-1 lg:py-2 text-white hover:bg-cyan-600 transition active:scale-90">
